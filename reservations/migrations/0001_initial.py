# Generated by Django 4.2.10 on 2024-04-02 15:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='room_type_name', to='reservations.roomtype')),
                ('services', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_name', to='reservations.service')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='room_status', to='reservations.status')),
            ],
        ),
        migrations.CreateModel(
            name='Reservation',
